...
from custom_models import ViTModel
...
class Pix2Pix3D(pl.LightningModule):
    def __init__(
        ...
        ### Model ###
        self.model = ViTModel(input_nc=in_channels, output_nc=out_channels)#UNet(input_nc=in_channels, output_nc=out_channels, net_G_channel=32, net_G_depth=6, net_G_drop_out=0)
